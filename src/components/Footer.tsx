    ...
    <footer className="bg-gray-900 text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-serif font-bold mb-4">QUARTERENDS</h3>
            <p className="text-gray-400 text-sm">
              Timeless elegance, modern luxury. Curated fashion for the discerning.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link to="/shop?category=women" className="hover:text-white transition">Women</Link></li>
              <li><Link to="/shop?category=men" className="hover:text-white transition">Men</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <p>© 2025 Quarterends. All rights reserved.</p>
