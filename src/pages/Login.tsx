    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-sm w-full">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                id="remember-me"
                type="checkbox"
                className="h-3.5 w-3.5 text-gray-900 border-gray-300"
              />
              <label htmlFor="remember-me" className="ml-2 text-xs text-gray-400">
                Remember me
              </label>
            </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          ...
          <Link to="/signup" className="underline text-gray-500 hover:text-gray-700 transition-colors">
            Sign up
          </Link>
        </p>
      </div>
